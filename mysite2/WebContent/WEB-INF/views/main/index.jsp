...
<body>
	<div id="wrap">
		...
		<c:import url="/WEB-INF/views/includes/header.jsp"></c:import> <!-- 글자만 가져오기 때문에 원본 소스의 글자가 나타남  -->
		<!-- //header & navi -->
		...
		<c:import url="/WEB-INF/views/includes/footer.jsp"></c:import> <!--글자만 가져오기 때문에 원본 소스의 글자가 나타남  -->
		<!-- //footer -->
